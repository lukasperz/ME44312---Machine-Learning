...
DATA_DIR = r"C:\Users\danie\OneDrive - Delft University of Technology\Q3\Machine Learning\DATA_EVALUATE_GREEN" # path to folder in order to read data


columns_to_keep = ["lpep_pickup_datetime", "RatecodeID", "trip_distance", "fare_amount"] # we just need a few columns from the entire dataset
...
df["weekday"] = pd.to_datetime(df["lpep_pickup_datetime"]).dt.weekday < 5  # True for weekday, False for weekend
